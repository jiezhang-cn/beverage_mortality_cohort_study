...
ukb_beverage_data <- read.csv("C:/Users/张杰/Desktop/ckm_beverage_mortality/data/ukb_beverage_data")
...
# 如果需要，重新定义process_beverage_intake函数
process_beverage_intake <- function(data, var_prefix) {
  base_name <- gsub("_f[0-9]+$", "", var_prefix)
  cols <- paste0(var_prefix, "_", 0:4, "_0")
  new_var_name <- base_name
...
coffee_tea_alternative_data <- read.csv("C:/Users/张杰/Desktop/ckm_beverage_mortality/data/ukb_beverage_data")
